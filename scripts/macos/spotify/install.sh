#!/bin/bash
set -euo pipefail
# Spotify macOS install (MDM Script)

DMG_URL="PASTE_YOUR_SPOTIFY_DMG_URL_HERE"
EXPECTED_SHA256=""
LOG_FILE="/var/log/mdm-spotify-install.log"
...
log "Starting Spotify install."
TMP_DIR="$(mktemp -d)"
DMG_PATH="$TMP_DIR/spotify.dmg"
