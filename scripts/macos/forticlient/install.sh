#!/bin/bash
set -euo pipefail
# FortiClient macOS install (MDM Script)

DMG_URL="PASTE_YOUR_FORTICLIENT_DMG_URL_HERE"
EXPECTED_SHA256=""
LOG_FILE="/var/log/mdm-forticlient-install.log"
...
log "Starting FortiClient install."
TMP_DIR="$(mktemp -d)"
DMG_PATH="$TMP_DIR/forticlient.dmg"
