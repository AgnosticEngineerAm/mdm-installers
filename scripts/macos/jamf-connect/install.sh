#!/bin/bash
set -euo pipefail
# Jamf Connect macOS install (MDM Script)

PKG_URL="PASTE_YOUR_JAMF_CONNECT_PKG_URL_HERE"
EXPECTED_SHA256=""
LOG_FILE="/var/log/mdm-jamf-connect-install.log"
...
log "Starting Jamf Connect install."
TMP_DIR="$(mktemp -d)"
PKG_PATH="$TMP_DIR/jamf-connect.pkg"
