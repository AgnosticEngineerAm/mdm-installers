#!/bin/bash
set -euo pipefail
# OBS Studio macOS install (MDM Script)

DMG_URL="PASTE_YOUR_OBS_STUDIO_DMG_URL_HERE"
EXPECTED_SHA256=""
LOG_FILE="/var/log/mdm-obs-studio-install.log"
...
log "Starting OBS Studio install."
TMP_DIR="$(mktemp -d)"
DMG_PATH="$TMP_DIR/obs-studio.dmg"
