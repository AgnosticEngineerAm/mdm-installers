#!/bin/bash
set -euo pipefail
# Evernote macOS install (MDM Script)

DMG_URL="PASTE_YOUR_EVERNOTE_DMG_URL_HERE"
EXPECTED_SHA256=""
LOG_FILE="/var/log/mdm-evernote-install.log"
...
log "Starting Evernote install."
TMP_DIR="$(mktemp -d)"
DMG_PATH="$TMP_DIR/evernote.dmg"
