#!/bin/bash
set -euo pipefail
# Grammarly macOS install (MDM Script)

DMG_URL="PASTE_YOUR_GRAMMARLY_DMG_URL_HERE"
EXPECTED_SHA256=""
LOG_FILE="/var/log/mdm-grammarly-install.log"
...
log "Starting Grammarly install."
TMP_DIR="$(mktemp -d)"
DMG_PATH="$TMP_DIR/grammarly.dmg"
...
log "SUCCESS: Grammarly installed."
