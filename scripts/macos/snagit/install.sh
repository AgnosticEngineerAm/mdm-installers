#!/bin/bash
set -euo pipefail
# Snagit macOS install (MDM Script)

DMG_URL="PASTE_YOUR_SNAGIT_DMG_URL_HERE"
EXPECTED_SHA256=""
LOG_FILE="/var/log/mdm-snagit-install.log"
...
log "Starting Snagit install."
TMP_DIR="$(mktemp -d)"
DMG_PATH="$TMP_DIR/snagit.dmg"
